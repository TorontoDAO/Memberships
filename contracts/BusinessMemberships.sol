...
contract TDAOBusinessMembership is Initializable, ERC721Upgradeable, OwnableUpgradeable, EIP712Upgradeable, ERC721VotesUpgradeable, UUPSUpgradeable {
    ...
    function initialize() initializer public {
        __ERC721_init("TDAO Business Membership", "TDAO");
        __Ownable_init(msg.sender);
        __EIP712_init("TDAO Business Membership", "1");
        __ERC721Votes_init();
